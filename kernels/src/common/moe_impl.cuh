...
#error "MOE_COMPUTE_CAPABILITY_MAJOR must be defined by the architecture translation unit"
#endif
...
void launch_forward(
    ...
    if constexpr (D_MODEL >= 256) {
        launch_sm80_medium_forward<SAVE_RAW_OUTPUT>(
            gate_globals,
            down_globals,
            blocks,
            stream
